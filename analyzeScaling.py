...
dseSizeBool2 = len(np.loadtxt('./benchmarks/' + direc + '' + technology + '/getBool2.txt', delimiter="|", unpack=True)[0])
dseSizeBool1 = len(np.loadtxt('./benchmarks/' + direc + '' + technology + '/getBool1.txt', delimiter="|", unpack=True)[0])
differentResource8 = len(np.loadtxt('./benchmarks/' + direc2 + '' + technology + '/getBool8.txt', delimiter="|", unpack=True)[0])
differentResource4 = len(np.loadtxt('./benchmarks/' + direc2 + '' + technology + '/getBool4.txt', delimiter="|", unpack=True)[0])
differentResource2 = len(np.loadtxt('./benchmarks/' + direc2 + '' + technology + '/getBool2.txt', delimiter="|", unpack=True)[0])
...
dseSizeSet2 = len(np.loadtxt('./benchmarks/' + direc + '' + technology + '/setBool2.txt', delimiter="|", unpack=True)[0])
dseSizeSet1 = len(np.loadtxt('./benchmarks/' + direc + '' + technology + '/setBool1.txt', delimiter="|", unpack=True)[0])
differentResource8 = len(np.loadtxt('./benchmarks/' + direc2 + '' + technology + '/setBool8.txt', delimiter="|", unpack=True)[0])
differentResource4 = len(np.loadtxt('./benchmarks/' + direc2 + '' + technology + '/setBool4.txt', delimiter="|", unpack=True)[0])
differentResource2 = len(np.loadtxt('./benchmarks/' + direc2 + '' + technology + '/setBool2.txt', delimiter="|", unpack=True)[0])
...
dseSizeArray2 = len(np.loadtxt('./benchmarks/' + direc + '' + technology + '/addArray2.txt', delimiter="|", unpack=True)[0])
dseSizeArray1 = len(np.loadtxt('./benchmarks/' + direc + '' + technology + '/addArray1.txt', delimiter="|", unpack=True)[0])
differentResource8 = len(np.loadtxt('./benchmarks/' + direc2 + '' + technology + '/addArray8.txt', delimiter="|", unpack=True)[0])
differentResource4 = len(np.loadtxt('./benchmarks/' + direc2 + '' + technology + '/addArray4.txt', delimiter="|", unpack=True)[0])
differentResource2 = len(np.loadtxt('./benchmarks/' + direc2 + '' + technology + '/addArray2.txt', delimiter="|", unpack=True)[0])
