...
object BDBStringTests {
    ...
    private class SetStringThread(time: Long, threadNum: Int, workerThreads: Int, val uuid: String, val con: BigchainDBConnectionDetails): TestThread(workerThreads, threadNum, time, true, "setString", "bdb") {
        ...
        override fun testFunc(): Boolean {
            ...
            if (latestMetaData["value"]!! == setValue as String) {
                return true
            }
